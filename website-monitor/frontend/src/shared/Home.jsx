...
const Home = () => {
  ...
  return (
    <div>
      {!show && (
        <div className="flex items-center justify-center min-h-[100vh] bg-black/70">
          <LottieAnimation animation="/web-takeoff.lottie" />
        </div>
      )}
        ...
        <div className="min-h-screen max-w-[80rem] w-full mx-auto">
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              Ensure your website is always online and performing at its best.
              Get notified instantly if any issues arise.
            </motion.p>
